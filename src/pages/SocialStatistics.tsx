      ...
      <div className="container py-8 space-y-8">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-semibold">Monitoring Susenas Maret 2025</h2>
              <Button
                variant="ghost"
                size="icon"
            ...
            {isSsnM25Visible && (
              <Tabs defaultValue="dashboardSsnM25" className="space-y-6 mt-6">
                ...
                <TabsContent value="dashboardSsnM25" className="mt-6">
                  <DashboardSsnM25Section />
                </TabsContent>
                <TabsContent value="inputPclSsnM25" className="mt-6">
                  <InputPclSsnM25Section />
                </TabsContent>
                <TabsContent value="inputPmlSsnM25" className="mt-6">
