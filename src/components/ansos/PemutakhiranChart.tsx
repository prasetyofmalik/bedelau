...
export function PemutakhiranChart({
  data,
  surveyType,
}: PemutakhiranChartProps) {
  ...
  return (
    <div className="w-[80%] aspect-square max-w-md mx-auto mb-4">
      <h3 className="text-xl font-semibold text-secondary mx-3 text-center">
        Pemutakhiran
      </h3>
          ...
          <Pie
            ...
            onMouseEnter={(data, index) => {
              const paths = document.querySelectorAll(
                `.${surveyType}-pemutakhiran-chart .recharts-sector`
              );
